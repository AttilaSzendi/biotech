                        ...
                        <form method="post" action="{{ route('products.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('published_from') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="published_from" id="input-published_from" class="form-control form-control-alternative{{ $errors->has('published_from') ? ' is-invalid' : '' }}" placeholder="{{ __('Publish from') }}" value="{{ old('published_from') }}">
                                ...
                                <div class="form-group{{ $errors->has('published_until') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="published_until" id="input-published_until" class="form-control form-control-alternative{{ $errors->has('published_until') ? ' is-invalid' : '' }}" placeholder="{{ __('Publish until') }}" value="{{ old('published_until') }}">
